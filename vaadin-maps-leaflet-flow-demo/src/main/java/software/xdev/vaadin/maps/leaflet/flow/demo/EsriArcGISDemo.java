...
import software.xdev.vaadin.maps.leaflet.addons.esri.LEsriFeatureLayer;
import software.xdev.vaadin.maps.leaflet.addons.esri.LEsriFeatureLayerOptions;
...
@Route(EsriArcGISDemo.NAV)
public class EsriArcGISDemo extends VerticalLayout
{
	public static final String NAV = "/arcgis";
	
	public EsriArcGISDemo()
	{
		...
		LEsriFeatureLayer featureLayer = new LEsriFeatureLayer(
			reg,
			new LEsriFeatureLayerOptions(
